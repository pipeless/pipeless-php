...
/**
 * V1AppsAppIdEventsEvent1 Class Doc Comment
 *
 * @category Class
 * @description Details to specify which event(s) should be deleted. Only events that match all 3 event parts (start, relationship, end) will be deleted.
 * @package  Pipeless
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class V1AppsAppIdEventsEvent1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_apps__app_id__events_event_1';
    ...
    protected static $openAPITypes = [
        'start_object' => '\Pipeless\Model\ObjectLookup',
        'relationship' => '\Pipeless\Model\V1AppsAppIdEventsEvent1Relationship',
        'end_object' => '\Pipeless\Model\ObjectWildcardLookup'
    ];
     ...
     * Sets start_object
     *
     * @param \Pipeless\Model\ObjectLookup $start_object start_object
     *
     * @return $this
     */
     ...
     * Gets relationship
     *
     * @return \Pipeless\Model\V1AppsAppIdEventsEvent1Relationship
     */
     ...
     * Sets relationship
     *
     * @param \Pipeless\Model\V1AppsAppIdEventsEvent1Relationship $relationship relationship
     *
     * @return $this
     */
     ...
     * Gets end_object
     *
     * @return \Pipeless\Model\ObjectWildcardLookup
     */
     ...
     * Sets end_object
     *
     * @param \Pipeless\Model\ObjectWildcardLookup $end_object end_object
     *
     * @return $this
     */
