...
/**
 * ObjectReadable Class Doc Comment
 *
 * @category Class
 * @package  Pipeless
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ObjectReadable implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectReadable';
    ...
    {
        if ((mb_strlen($id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ObjectReadable., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ObjectReadable., must be bigger than or equal to 1.');
        }
